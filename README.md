...
| scylladb           | `scylladb://[<user>:<password>@]<host>[:<port>]/[<keyspace>][?node=<host>:<port>][&datacenter=<dc>][&sslmode=<disable\|verify-full>][&ssl_ca=<pem-file>][&ssl_cert=<pem-file>&ssl_key=<pem-file>][&client_route=<connection-id>]`                                          |
