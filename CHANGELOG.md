...
## `rsql_cli` - [0.19.1](https://github.com/theseus-rs/rsql/compare/v0.19.0...v0.19.1) - 2025-06-03

### Other
- fix 'system' command demo
- clean up completer, add convenience function for current schema

## `rsql_repl` - [0.19.1](https://github.com/theseus-rs/rsql/compare/rsql_repl-v0.19.0...rsql_repl-v0.19.1) - 2025-06-03

### Other
- clean up completer, add convenience function for current schema

## `rsql_driver` - [0.19.1](https://github.com/theseus-rs/rsql/compare/rsql_driver-v0.19.0...rsql_driver-v0.19.1) - 2025-06-03
